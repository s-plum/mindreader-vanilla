Element.prototype.mindreader = function (mindreaderConfig) {
    ...
    var MindReader = {
            ...
            search: function () {
                ...
                if (value.length >= self.config.minLength) {
                    self.searchTimeout = setTimeout(function () {
                        if (self.config.postData != null && typeof self.config.postData == 'function' && typeof self.config.postData() == 'object')
                            var dataObject = JSON.stringify(self.config.postData());
                        else
                            var dataObject = null;
            ...
            positionResults: function () {
                var self = this, height = self.el.offsetHeight, width = self.el.offsetWidth, xpos = self.el.offsetLeft, ypos = self.el.offsetTop;
...
define('mindreader-vanilla', [], function () {
    return;
});
...
define('demo-basic', ['mindreader-vanilla'], function () {
    return;
});