            ...
            search: function () {
                ...
                if (value.length >= self.params.minLength) {
                    self.searchTimeout = setTimeout(function () {
                        if (self.params.postData != null && typeof self.params.postData == 'function' && typeof self.params.postData() == 'object')
                            var dataObject = JSON.stringify(self.params.postData());
                        else
                            var dataObject = null;
